 ...
 */
export function interpretTsTypeBinding(
	...
	const isMapTupleEntry =
		captures["@type-binding.map-tuple-entry"] !== undefined;
	const isInstanceofNarrow =
		captures["@type-binding.instanceof-narrow"] !== undefined;
