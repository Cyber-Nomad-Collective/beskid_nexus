...
import type { TypeArgPosition } from "./contracts.js";
import { extractElementTypeFromString } from "./output.js";
...
const CONTAINER_DESCRIPTORS: ReadonlyMap<string, ContainerDescriptor> = new Map(
	[
		...
		[
			"Map",
			{ arity: 2, keyMethods: STD_KEY_METHODS, valueMethods: STD_VALUE_METHODS },
		],
		[
			"WeakMap",
			{ arity: 2, keyMethods: STD_KEY_METHODS, valueMethods: STD_VALUE_METHODS },
