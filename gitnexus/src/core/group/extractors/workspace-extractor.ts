...
export async function discoverWorkspaceLinks(
	...
	const rustResult = await extractRustWorkspaceLinks(
		repos,
		repoPaths,
		dbExecutors,
	);
	...
	const nodeResult = await extractNodeWorkspaceLinks(
		repos,
		repoPaths,
		dbExecutors,
	);
	...
	const pyResult = await extractPythonWorkspaceLinks(
		repos,
		repoPaths,
		dbExecutors,
	);
	...
	const elixirResult = await extractElixirWorkspaceLinks(
		repos,
		repoPaths,
		dbExecutors,
	);
