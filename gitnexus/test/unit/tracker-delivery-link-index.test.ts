...
import { trackerDeliveryNodeId, trackerDeliveryRelation } from '../../src/server/nexus/spec-link-index.js';
...
describe('Tracker delivery link index', () => {
	it('keys Tracker nodes and typed OpenSpec relations by tracker ID plus catalog revision', () => {
		expect(trackerDeliveryNodeId('task-1', 'catalog-5')).toBe('tracker:task-1:catalog-5');
		expect(
