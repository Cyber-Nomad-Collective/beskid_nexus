...
`;
		...
		const shapeCtor = results.find(
			(r) =>
				r.name === "Shape" && r.enclosingClassId === "Class:src/shapes.h:Shape",
		);
		...
		const area = results.find(
			(r) =>
				r.name === "area" && r.enclosingClassId === "Class:src/shapes.h:Shape",
		);
		...
		const circleCtor = results.find(
			(r) =>
				r.name === "Circle" && r.enclosingClassId === "Class:src/shapes.h:Circle",
		);
		expect(circleCtor).toBeDefined();

		const circleArea = results.find(
			(r) =>
				r.name === "area" && r.enclosingClassId === "Class:src/shapes.h:Circle",
		);
